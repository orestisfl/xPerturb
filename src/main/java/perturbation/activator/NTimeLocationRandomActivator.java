 ...
 */
public class NTimeLocationRandomActivator extends RandomActivator {

    private int n;

    public NTimeLocationRandomActivator(float epsilon, int n) {
        super(epsilon);
        this.n = n;
    }

    public NTimeLocationRandomActivator(float epsilon, int seed, int n) {
        super(epsilon, seed);
        this.n = n;
    }
