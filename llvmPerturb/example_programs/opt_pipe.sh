...
if [[ "$1" == "big" ]] || [[ "$2" == "big" ]]; then
  ...
  opt -load "$HOME/llvm-8.0.0.src/build/lib/LLVMRandom.so" -Random < linked_challenge.bc > linked_challenge_opt.bc

  echo "OUTPUT:    c1 bd 88 bf e6 5e 87 01 3f 3f 41 96 c1 8a f3 68 - EXPECTED"

  chmod +x linked_challenge.bc
  chmod +x linked_challenge_opt.bc
  ./linked_challenge.bc 00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f
  ./linked_challenge_opt.bc 00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f
