...
@.str = private unnamed_addr constant [9 x i8] c"Equals!\0A\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"Equls not\0A\00", align 1
...
; <label>:8:                                      ; preds = %0
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0))
  br label %12
